...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/accueil_responsive.css')); ?>">
</head>
...
<body>
    ...
    <header>
        <div class="navbar">
            ...
            <ul class="navlink">
                <li class="page-active"><a href="<?php echo e(route('accueil')); ?>">Accueil</a></li>
        ...
        <section class="hero">
            <div class="hero-inner">
                ...
                <div class="hero-illustration">
                    <div class="img"><img src="<?php echo e(asset('img/OriceftStudents3.png')); ?>" alt="etudiant" width="450px"></div>
                </div>
            </div>
        </section>
...
</html><?php /**PATH H:\test\test\resources\views/accueil.blade.php ENDPATH**/ ?>